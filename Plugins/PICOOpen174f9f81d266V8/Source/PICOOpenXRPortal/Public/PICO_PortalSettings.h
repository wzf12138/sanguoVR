...
#include "PICO_PortalSettings.generated.h"

/**
 * PICO Portal Settings
 */
UCLASS(config = EditorPerProjectUserSettings)
class PICOOPENXRPORTAL_API UPICO_PortalSettings : public UObject
{
	GENERATED_BODY()
public:
	UPROPERTY(config, EditAnywhere, Category = PICOOpenXR)
...
class PICOOPENXRPORTAL_API UPICO_RenderSettings : public UObject
{
	GENERATED_BODY()
...
public:
	...
	TEnumAsByte<EUnrealEngineTypePICO::Type> TypeEngine=EUnrealEngineTypePICO::Type::Official_Engine;
