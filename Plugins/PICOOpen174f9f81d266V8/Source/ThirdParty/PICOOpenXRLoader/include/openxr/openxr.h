...
typedef enum XrResult {
    ...
    XR_ERROR_CAMERA_UNAVAILABLE_PICO = -1010033000,
    XR_ERROR_CAMERA_OCCUPIED_PICO = -1010033001,
    XR_ERROR_CAMERA_CAPTURE_SESSION_CAPTURING_PICO = -1010033002,
    XR_ERROR_CAMERA_CAPTURE_SESSION_NOT_CAPTURING_PICO = -1010033003,
    XR_ERROR_CAMERA_ID_INVALID_PICO = -1010033004,
    XR_ERROR_CAMERA_IMAGE_ID_INVALID_PICO = -1010033005,
    XR_ERROR_CAMERA_PROPERTY_TYPE_INVALID_PICO = -1010033006,
    XR_ERROR_CAMERA_CAPABILITY_TYPE_INVALID_PICO = -1010033007,
    XR_CAMERA_IMAGE_NO_UPDATE_PICO = 1010033000,
...
typedef enum XrStructureType {
    ...
    XR_TYPE_EYE_TRACKER_CREATE_INFO_PICO = 1010006001,
    XR_TYPE_EYE_TRACKER_DATA_INFO_PICO = 1010006002,
    XR_TYPE_EYE_TRACKER_DATA_PICO = 1010006003,
    XR_TYPE_EYE_DATA_PICO = 1010006004,
    XR_TYPE_EYE_TRACKER_GAZE_INFO_PICO = 1010006005,
    XR_TYPE_EYE_TRACKER_GAZE_PICO = 1010006006,
    XR_TYPE_EYE_GAZE_PICO = 1010006007,
    XR_TYPE_EYE_TRACKER_GAZE_DEPTH_PICO = 1010006008,
    ...
    XR_TYPE_AVAILABLE_CAMERAS_ENUMERATE_INFO_PICO = 1010033000,
    XR_TYPE_CAMERA_PROPERTIES_GET_INFO_PICO = 1010033001,
    XR_TYPE_CAMERA_PROPERTIES_PICO = 1010033002,
    XR_TYPE_CAMERA_PROPERTY_FACING_PICO = 1010033003,
    XR_TYPE_CAMERA_PROPERTY_POSITION_PICO = 1010033004,
    XR_TYPE_CAMERA_PROPERTY_CAMERA_TYPE_PICO = 1010033005,
    XR_TYPE_CAMERA_SUPPORTED_CAPABILITIES_GET_INFO_PICO = 1010033006,
    XR_TYPE_CAMERA_SUPPORTED_CAPABILITIES_PICO = 1010033007,
    XR_TYPE_CAMERA_SUPPORTED_CAPABILITY_IMAGE_RESOLUTION_PICO = 1010033008,
    XR_TYPE_CAMERA_CAPABILITY_IMAGE_RESOLUTION_PICO = 1010033009,
    XR_TYPE_CAMERA_SUPPORTED_CAPABILITY_DATA_TRANSFER_TYPE_PICO = 1010033010,
    XR_TYPE_CAMERA_CAPABILITY_DATA_TRANSFER_TYPE_PICO = 1010033011,
    XR_TYPE_CAMERA_SUPPORTED_CAPABILITY_IMAGE_FORMAT_PICO = 1010033012,
    XR_TYPE_CAMERA_CAPABILITY_IMAGE_FORMAT_PICO = 1010033013,
    XR_TYPE_CAMERA_SUPPORTED_CAPABILITY_CAMERA_MODEL_PICO = 1010033014,
    XR_TYPE_CAMERA_CAPABILITY_CAMERA_MODEL_PICO = 1010033015,
    XR_TYPE_CAMERA_SUPPORTED_CAPABILITY_IMAGE_FPS_PICO = 1010033016,
    XR_TYPE_CAMERA_CAPABILITY_IMAGE_FPS_PICO = 1010033017,
    XR_TYPE_CAMERA_DEVICE_CREATE_INFO_PICO = 1010033018,
    XR_TYPE_CREATE_CAMERA_DEVICE_COMPLETION_PICO = 1010033019,
    XR_TYPE_CAMERA_CAPTURE_SESSION_CREATE_INFO_PICO = 1010033020,
    XR_TYPE_CREATE_CAMERA_CAPTURE_SESSION_COMPLETION_PICO = 1010033021,
    XR_TYPE_CAMERA_INTRINSICS_PICO = 1010033022,
    XR_TYPE_CAMERA_EXTRINSICS_PICO = 1010033023,
    XR_TYPE_CAMERA_CAPTURE_BEGIN_INFO_PICO = 1010033024,
    XR_TYPE_CAMERA_IMAGE_ACQUIRE_INFO_PICO = 1010033025,
    XR_TYPE_CAMERA_IMAGE_PICO = 1010033026,
    XR_TYPE_CAMERA_IMAGE_DATA_RAW_BUFFER_PICO = 1010033027,
    XR_TYPE_CAMERA_CAPABILITIES_PICO = 1010033028,
    ...
    XR_TYPE_SHARED_SPATIAL_ANCHOR_DOWNLOAD_INFO_PICO = 1200391003,
    XR_TYPE_SHARED_SPATIAL_ANCHOR_DOWNLOAD_COMPLETION_PICO = 1200391004,
...
typedef enum XrObjectType {
    ...
    XR_OBJECT_TYPE_CAMERA_DEVICE_PICO = 1010033000,
    XR_OBJECT_TYPE_CAMERA_CAPTURE_SESSION_PICO = 1010033001,
    XR_OBJECT_TYPE_READBACK_TEXTURE_PICO = 1010029000,
...
typedef struct XrEyeTrackerGazeInfoPICO {
    XrStructureType             type;
    const void* XR_MAY_ALIAS    next;
    XrEyeTrackerFlagsPICO       flags;
    XrTime                      time;
    XrSpace                     baseSpace;
} XrEyeTrackerGazeInfoPICO;
...
typedef struct XrEyeTrackerGazePICO {
    XrStructureType       type;
    void* XR_MAY_ALIAS    next;
    XrEyeGazePICO         leftEyeGaze;
    XrEyeGazePICO         rightEyeGaze;
} XrEyeTrackerGazePICO;

typedef struct XrEyeTrackerGazeDepthPICO {
    XrStructureType       type;
    void* XR_MAY_ALIAS    next;
    XrBool32              isValid;
    float                 depthConfidence;
    float                 gazeDepth;
} XrEyeTrackerGazeDepthPICO;
...
typedef XrResult (XRAPI_PTR *PFN_xrGetEyeGazePICO)(XrEyeTrackerPICO tracker, const XrEyeTrackerGazeInfoPICO* info, XrEyeTrackerGazePICO* gaze);
...
XRAPI_ATTR XrResult XRAPI_CALL xrGetEyeGazePICO(
    XrEyeTrackerPICO                            tracker,
    const XrEyeTrackerGazeInfoPICO*             info,
    XrEyeTrackerGazePICO*                       gaze);
#endif /* XR_EXTENSION_PROTOTYPES */
#endif /* !XR_NO_PROTOTYPES */
...
#define XR_PICO_secure_mixed_reality_SPEC_VERSION 2
...
// XR_PICO_dynamic_object_tracking is a preprocessor guard. Do not pass it to API calls.
#define XR_PICO_dynamic_object_tracking 1
XR_DEFINE_ATOM(XrSpatialEntityIdPICO)
#define XR_PICO_dynamic_object_tracking_SPEC_VERSION 1
#define XR_PICO_DYNAMIC_OBJECT_TRACKING_EXTENSION_NAME "XR_PICO_dynamic_object_tracking"

typedef enum XrDynamicObjectTypePICO {
    XR_DYNAMIC_OBJECT_TYPE_UNKNOWN_PICO = 0,
    XR_DYNAMIC_OBJECT_TYPE_KEYBOARD_PICO = 1010018000,
    XR_DYNAMIC_OBJECT_TYPE_MOUSE_PICO = 1010019000,
    XR_DYNAMIC_OBJECT_TYPE_MAX_ENUM_PICO = 0x7FFFFFFF
} XrDynamicObjectTypePICO;
...
typedef enum XrSpatialEntityComponentTypePICO {
    ...
    XR_SPATIAL_ENTITY_COMPONENT_TYPE_SPHERE_PICO = 6,
    XR_SPATIAL_ENTITY_COMPONENT_TYPE_DYNAMIC_OBJECT_PICO = 1010017000,
    XR_SPATIAL_ENTITY_COMPONENT_TYPE_MAX_ENUM_PICO = 0x7FFFFFFF
} XrSpatialEntityComponentTypePICO;
// XrSystemDynamicObjectTrackingPropertiesPICO extends XrSystemProperties
typedef struct XrSystemDynamicObjectTrackingPropertiesPICO {
    XrStructureType       type;
    void* XR_MAY_ALIAS    next;
    XrBool32              supportsDynamicObjectTracking;
} XrSystemDynamicObjectTrackingPropertiesPICO;

// XrSenseDataProviderCreateInfoDynamicObjectPICO extends XrSenseDataProviderCreateInfoBD
typedef struct XrSenseDataProviderCreateInfoDynamicObjectPICO {
    XrStructureType                   type;
    const void* XR_MAY_ALIAS          next;
    uint32_t                          trackingTypeCount;
    const XrDynamicObjectTypePICO*    trackingTypes;
} XrSenseDataProviderCreateInfoDynamicObjectPICO;

// XrSpatialEntityDynamicObjectGetInfoPICO extends XrSpatialEntityComponentGetInfoBaseHeaderPICO
typedef struct XrSpatialEntityDynamicObjectGetInfoPICO {
    XrStructureType                     type;
    const void* XR_MAY_ALIAS            next;
    XrSpatialEntityIdPICO               entity;
    XrSpatialEntityComponentTypePICO    componentType;
} XrSpatialEntityDynamicObjectGetInfoPICO;

typedef struct XrDynamicObjectDataPICO {
    XrStructureType            type;
    void* XR_MAY_ALIAS         next;
    XrDynamicObjectTypePICO    objectType;
} XrDynamicObjectDataPICO;

// XrSpatialEntityComponentDataDynamicObjectPICO extends XrSpatialEntityComponentDataBaseHeaderPICO
typedef struct XrSpatialEntityComponentDataDynamicObjectPICO {
    XrStructureType            type;
    void* XR_MAY_ALIAS         next;
    XrDynamicObjectDataPICO    data;
} XrSpatialEntityComponentDataDynamicObjectPICO;

typedef struct XrSenseDataFilterDynamicObjectTypePICO {
    XrStructureType                   type;
    const void* XR_MAY_ALIAS          next;
    uint32_t                          typeCount;
    const XrDynamicObjectTypePICO*    types;
} XrSenseDataFilterDynamicObjectTypePICO;



// XR_PICO_dynamic_object_keyboard is a preprocessor guard. Do not pass it to API calls.
#define XR_PICO_dynamic_object_keyboard 1
#define XR_PICO_dynamic_object_keyboard_SPEC_VERSION 1
#define XR_PICO_DYNAMIC_OBJECT_KEYBOARD_EXTENSION_NAME "XR_PICO_dynamic_object_keyboard"
// XrSystemDynamicObjectKeyboardPropertiesPICO extends XrSystemProperties
typedef struct XrSystemDynamicObjectKeyboardPropertiesPICO {
    XrStructureType       type;
    void* XR_MAY_ALIAS    next;
    XrBool32              supportsDynamicObjectKeyboard;
} XrSystemDynamicObjectKeyboardPropertiesPICO;



// XR_PICO_dynamic_object_mouse is a preprocessor guard. Do not pass it to API calls.
#define XR_PICO_dynamic_object_mouse 1
#define XR_PICO_dynamic_object_mouse_SPEC_VERSION 1
#define XR_PICO_DYNAMIC_OBJECT_MOUSE_EXTENSION_NAME "XR_PICO_dynamic_object_mouse"
// XrSystemDynamicObjectMousePropertiesPICO extends XrSystemProperties
typedef struct XrSystemDynamicObjectMousePropertiesPICO {
    XrStructureType       type;
    void* XR_MAY_ALIAS    next;
    XrBool32              supportsDynamicObjectMouse;
} XrSystemDynamicObjectMousePropertiesPICO;
...
#define XR_PICO_readback_tensor_SPEC_VERSION 2
...
typedef struct XR_MAY_ALIAS XrReadbackTextureImageBaseHeaderPICO {
       XrStructureType          type;
    const void* XR_MAY_ALIAS    next;
} XrReadbackTextureImageBaseHeaderPICO;
...
typedef XrResult (XRAPI_PTR *PFN_xrGetReadbackTextureImagePICO)(XrReadbackTexturePICO readbackTexture, XrReadbackTextureImageBaseHeaderPICO*  img);
...
XRAPI_ATTR XrResult XRAPI_CALL xrGetReadbackTextureImagePICO(
    ...
    XrReadbackTextureImageBaseHeaderPICO*       img);
...
// XR_PICO_camera_image is a preprocessor guard. Do not pass it to API calls.
...
} XrCameraPositionPICO;

typedef enum XrCameraTypePICO {
...
typedef enum XrCameraDataTransferTypePICO {
    XR_CAMERA_DATA_TRANSFER_TYPE_RAW_BUFFER_PICO = 1,
    XR_CAMERA_DATA_TRANSFER_TYPE_MAX_ENUM_PICO = 0x7FFFFFFF
} XrCameraDataTransferTypePICO;

typedef enum XrCameraImageFormatPICO {
    XR_CAMERA_IMAGE_FORMAT_RGBA_8888_PICO = 1,
    XR_CAMERA_IMAGE_FORMAT_MAX_ENUM_PICO = 0x7FFFFFFF
} XrCameraImageFormatPICO;

typedef enum XrCameraModelPICO {
    XR_CAMERA_MODEL_PINHOLE_PICO = 1,
    XR_CAMERA_MODEL_MAX_ENUM_PICO = 0x7FFFFFFF
} XrCameraModelPICO;

typedef enum XrCameraImageFpsPICO {
    XR_CAMERA_IMAGE_FPS_30_PICO = 1,
    XR_CAMERA_IMAGE_FPS_60_PICO = 2,
    XR_CAMERA_IMAGE_FPS_MAX_ENUM_PICO = 0x7FFFFFFF
} XrCameraImageFpsPICO;
typedef struct XR_MAY_ALIAS XrCameraPropertyBaseHeaderPICO {
    XrStructureType             type;
    const void* XR_MAY_ALIAS    next;
} XrCameraPropertyBaseHeaderPICO;

typedef struct XrCameraPropertiesPICO {
    XrStructureType                     type;
    const void* XR_MAY_ALIAS            next;
    uint32_t                            propertyCount;
    XrCameraPropertyBaseHeaderPICO**    properties;
} XrCameraPropertiesPICO;

typedef struct XR_MAY_ALIAS XrCameraCapabilityBaseHeaderPICO {
    XrStructureType             type;
    const void* XR_MAY_ALIAS    next;
} XrCameraCapabilityBaseHeaderPICO;

typedef struct XrCameraCapabilitiesPICO {
    XrStructureType                       type;
    const void* XR_MAY_ALIAS              next;
    uint32_t                              capabilityCount;
    XrCameraCapabilityBaseHeaderPICO**    capabilities;
} XrCameraCapabilitiesPICO;

typedef struct XrAvailableCamerasEnumerateInfoPICO {
    XrStructureType                    type;
    const void* XR_MAY_ALIAS           next;
    const XrCameraPropertiesPICO*      properties;
    const XrCameraCapabilitiesPICO*    capabilities;
} XrAvailableCamerasEnumerateInfoPICO;

typedef struct XrCameraPropertiesGetInfoPICO {
    XrStructureType             type;
    const void* XR_MAY_ALIAS    next;
    XrCameraIdPICO              cameraId;
} XrCameraPropertiesGetInfoPICO;

typedef struct XrCameraPropertyFacingPICO {
    XrStructureType             type;
    const void* XR_MAY_ALIAS    next;
    XrCameraFacingPICO          facing;
} XrCameraPropertyFacingPICO;

typedef struct XrCameraPropertyPositionPICO {
    XrStructureType             type;
    const void* XR_MAY_ALIAS    next;
    XrCameraPositionPICO        position;
} XrCameraPropertyPositionPICO;

typedef struct XrCameraPropertyCameraTypePICO {
    XrStructureType             type;
    const void* XR_MAY_ALIAS    next;
    XrCameraTypePICO            cameraType;
} XrCameraPropertyCameraTypePICO;

typedef struct XrCameraSupportedCapabilitiesGetInfoPICO {
    XrStructureType             type;
    const void* XR_MAY_ALIAS    next;
    XrCameraIdPICO              id;
} XrCameraSupportedCapabilitiesGetInfoPICO;

typedef struct XR_MAY_ALIAS XrCameraSupportedCapabilityBaseHeaderPICO {
    XrStructureType             type;
    const void* XR_MAY_ALIAS    next;
} XrCameraSupportedCapabilityBaseHeaderPICO;

typedef struct XrCameraSupportedCapabilitiesPICO {
    XrStructureType                                type;
    const void* XR_MAY_ALIAS                       next;
    uint32_t                                       capabilityCount;
    XrCameraSupportedCapabilityBaseHeaderPICO**    capabilities;
} XrCameraSupportedCapabilitiesPICO;

typedef struct XrCameraSupportedCapabilityImageResolutionPICO {
    XrStructureType             type;
    const void* XR_MAY_ALIAS    next;
    uint32_t                    resolutionCapacityInput;
    uint32_t                    resolutionCountOutput;
    XrExtent2Di*                resolutions;
} XrCameraSupportedCapabilityImageResolutionPICO;

typedef struct XrCameraCapabilityImageResolutionPICO {
    XrStructureType             type;
    const void* XR_MAY_ALIAS    next;
    XrExtent2Di                 resolution;
} XrCameraCapabilityImageResolutionPICO;

typedef struct XrCameraSupportedCapabilityDataTransferTypePICO {
    XrStructureType                  type;
    const void* XR_MAY_ALIAS         next;
    uint32_t                         typeCapacityInput;
    uint32_t                         typeCountOutput;
    XrCameraDataTransferTypePICO*    types;
} XrCameraSupportedCapabilityDataTransferTypePICO;

typedef struct XrCameraCapabilityDataTransferTypePICO {
    XrStructureType                 type;
    const void* XR_MAY_ALIAS        next;
    XrCameraDataTransferTypePICO    transferType;
} XrCameraCapabilityDataTransferTypePICO;

typedef struct XrCameraSupportedCapabilityImageFormatPICO {
    XrStructureType             type;
    const void* XR_MAY_ALIAS    next;
    uint32_t                    formatCapacityInput;
    uint32_t                    formatCountOutput;
    XrCameraImageFormatPICO*    formats;
} XrCameraSupportedCapabilityImageFormatPICO;

typedef struct XrCameraCapabilityImageFormatPICO {
    XrStructureType             type;
    const void* XR_MAY_ALIAS    next;
    XrCameraImageFormatPICO     format;
} XrCameraCapabilityImageFormatPICO;

typedef struct XrCameraSupportedCapabilityCameraModelPICO {
    XrStructureType             type;
    const void* XR_MAY_ALIAS    next;
...
typedef struct XrCameraCapabilityCameraModelPICO {
    XrStructureType             type;
    const void* XR_MAY_ALIAS    next;
    XrCameraModelPICO           model;
} XrCameraCapabilityCameraModelPICO;

typedef struct XrCameraSupportedCapabilityImageFpsPICO {
    XrStructureType             type;
    const void* XR_MAY_ALIAS    next;
    uint32_t                    fpsCapacityInput;
    uint32_t                    fpsCountOutput;
    XrCameraImageFpsPICO*       fps;
} XrCameraSupportedCapabilityImageFpsPICO;

typedef struct XrCameraCapabilityImageFpsPICO {
    XrStructureType             type;
    const void* XR_MAY_ALIAS    next;
    XrCameraImageFpsPICO        fps;
} XrCameraCapabilityImageFpsPICO;

typedef struct XrCameraDeviceCreateInfoPICO {
    XrStructureType             type;
    const void* XR_MAY_ALIAS    next;
    XrCameraIdPICO              cameraId;
} XrCameraDeviceCreateInfoPICO;

typedef struct XrCreateCameraDeviceCompletionPICO {
    XrStructureType       type;
    void* XR_MAY_ALIAS    next;
    XrResult              futureResult;
    XrCameraDevicePICO    device;
} XrCreateCameraDeviceCompletionPICO;

typedef struct XrCameraCaptureSessionCreateInfoPICO {
    XrStructureType                                   type;
    const void* XR_MAY_ALIAS                          next;
    XrCameraDevicePICO                                camera;
    uint32_t                                          configCount;
    const XrCameraCapabilityBaseHeaderPICO* const*    configs;
} XrCameraCaptureSessionCreateInfoPICO;

typedef struct XrCreateCameraCaptureSessionCompletionPICO {
    XrStructureType               type;
    void* XR_MAY_ALIAS            next;
    XrResult                      futureResult;
    XrCameraCaptureSessionPICO    captureSession;
} XrCreateCameraCaptureSessionCompletionPICO;

typedef struct XrCameraIntrinsicsPICO {
    XrStructureType             type;
    const void* XR_MAY_ALIAS    next;
    XrVector2f                  focalLength;
    XrVector2f                  principalPoint;
    XrVector2f                  fov;
} XrCameraIntrinsicsPICO;

typedef struct XrCameraExtrinsicsPICO {
    XrStructureType             type;
    const void* XR_MAY_ALIAS    next;
    XrPosef                     pose;
} XrCameraExtrinsicsPICO;

typedef struct XrCameraCaptureBeginInfoPICO {
    XrStructureType             type;
    const void* XR_MAY_ALIAS    next;
} XrCameraCaptureBeginInfoPICO;

typedef struct XrCameraImageAcquireInfoPICO {
    XrStructureType             type;
    const void* XR_MAY_ALIAS    next;
    XrTime                      lastCaptureTime;
} XrCameraImageAcquireInfoPICO;

typedef struct XrCameraImagePICO {
    XrStructureType             type;
    const void* XR_MAY_ALIAS    next;
    XrTime                      captureTime;
...
typedef struct XR_MAY_ALIAS XrCameraImageDataBaseHeaderPICO {
    XrStructureType             type;
    const void* XR_MAY_ALIAS    next;
} XrCameraImageDataBaseHeaderPICO;

typedef struct XrCameraImageDataRawBufferPICO {
    XrStructureType             type;
    const void* XR_MAY_ALIAS    next;
    uint32_t                    width;
    uint32_t                    height;
    ...
    uint32_t                    bufferSize;
    uint8_t*                    buffer;
} XrCameraImageDataRawBufferPICO;

typedef XrResult (XRAPI_PTR *PFN_xrEnumerateAvailableCamerasPICO)(XrInstance instance, const XrAvailableCamerasEnumerateInfoPICO* enumerateInfo, uint32_t cameraIdCapacityInput, uint32_t* cameraIdCountOutput, XrCameraIdPICO* cameraIds);
typedef XrResult (XRAPI_PTR *PFN_xrEnumerateCameraPropertyTypesPICO)(XrInstance instance, XrCameraIdPICO cameraId, uint32_t typeCapacityInput, uint32_t* typeCountOutput, XrCameraPropertyTypePICO* types);
typedef XrResult (XRAPI_PTR *PFN_xrGetCameraPropertiesPICO)(XrInstance instance, const XrCameraPropertiesGetInfoPICO* getInfo, XrCameraPropertiesPICO* properties);
typedef XrResult (XRAPI_PTR *PFN_xrEnumerateCameraCapabilityTypesPICO)(XrInstance instance, XrCameraIdPICO cameraId, uint32_t typeCapacityInput, uint32_t* typeCountOutput, XrCameraCapabilityTypePICO* types);
typedef XrResult (XRAPI_PTR *PFN_xrGetCameraSupportedCapabilitiesPICO)(XrInstance instance, const XrCameraSupportedCapabilitiesGetInfoPICO* getInfo, XrCameraSupportedCapabilitiesPICO* capabilities);
typedef XrResult (XRAPI_PTR *PFN_xrCreateCameraDeviceAsyncPICO)(XrInstance instance, const XrCameraDeviceCreateInfoPICO* createInfo, XrFutureEXT* future);
typedef XrResult (XRAPI_PTR *PFN_xrCreateCameraDeviceCompletePICO)(XrInstance instance, XrFutureEXT future, XrCreateCameraDeviceCompletionPICO* completion);
typedef XrResult (XRAPI_PTR *PFN_xrDestroyCameraDevicePICO)(XrCameraDevicePICO device);
typedef XrResult (XRAPI_PTR *PFN_xrCreateCameraCaptureSessionAsyncPICO)(XrSession session, const XrCameraCaptureSessionCreateInfoPICO* createInfo, XrFutureEXT* future);
typedef XrResult (XRAPI_PTR *PFN_xrCreateCameraCaptureSessionCompletePICO)(XrSession session, XrFutureEXT future, XrCreateCameraCaptureSessionCompletionPICO* completion);
typedef XrResult (XRAPI_PTR *PFN_xrDestroyCameraCaptureSessionPICO)(XrCameraCaptureSessionPICO captureSession);
typedef XrResult (XRAPI_PTR *PFN_xrGetCameraIntrinsicsPICO)(XrCameraCaptureSessionPICO session, XrCameraIntrinsicsPICO* intrinsics);
typedef XrResult (XRAPI_PTR *PFN_xrGetCameraExtrinsicsPICO)(XrCameraCaptureSessionPICO session, XrCameraExtrinsicsPICO* extrinsics);
typedef XrResult (XRAPI_PTR *PFN_xrBeginCameraCapturePICO)(XrCameraCaptureSessionPICO session, XrCameraCaptureBeginInfoPICO* beginInfo);
typedef XrResult (XRAPI_PTR *PFN_xrEndCameraCapturePICO)(XrCameraCaptureSessionPICO session);
typedef XrResult (XRAPI_PTR *PFN_xrAcquireCameraImagePICO)(XrCameraCaptureSessionPICO session, const XrCameraImageAcquireInfoPICO* acquireInfo, XrCameraImagePICO* image);
typedef XrResult (XRAPI_PTR *PFN_xrGetCameraImageDataPICO)(XrCameraCaptureSessionPICO session, XrCameraImageIdPICO imageId, XrCameraImageDataBaseHeaderPICO* imageData);
typedef XrResult (XRAPI_PTR *PFN_xrReleaseCameraImagePICO)(XrCameraCaptureSessionPICO session, XrCameraImageIdPICO imageId);

#ifndef XR_NO_PROTOTYPES
#ifdef XR_EXTENSION_PROTOTYPES
XRAPI_ATTR XrResult XRAPI_CALL xrEnumerateAvailableCamerasPICO(
    XrInstance                                  instance,
    const XrAvailableCamerasEnumerateInfoPICO*  enumerateInfo,
    uint32_t                                    cameraIdCapacityInput,
    uint32_t*                                   cameraIdCountOutput,
    XrCameraIdPICO*                             cameraIds);

XRAPI_ATTR XrResult XRAPI_CALL xrEnumerateCameraPropertyTypesPICO(
    XrInstance                                  instance,
    XrCameraIdPICO                              cameraId,
    uint32_t                                    typeCapacityInput,
    uint32_t*                                   typeCountOutput,
    XrCameraPropertyTypePICO*                   types);

XRAPI_ATTR XrResult XRAPI_CALL xrGetCameraPropertiesPICO(
    XrInstance                                  instance,
    const XrCameraPropertiesGetInfoPICO*        getInfo,
    XrCameraPropertiesPICO*                     properties);

XRAPI_ATTR XrResult XRAPI_CALL xrEnumerateCameraCapabilityTypesPICO(
    XrInstance                                  instance,
    XrCameraIdPICO                              cameraId,
    uint32_t                                    typeCapacityInput,
    uint32_t*                                   typeCountOutput,
    XrCameraCapabilityTypePICO*                 types);

XRAPI_ATTR XrResult XRAPI_CALL xrGetCameraSupportedCapabilitiesPICO(
    XrInstance                                  instance,
    const XrCameraSupportedCapabilitiesGetInfoPICO* getInfo,
    XrCameraSupportedCapabilitiesPICO*          capabilities);

XRAPI_ATTR XrResult XRAPI_CALL xrCreateCameraDeviceAsyncPICO(
    XrInstance                                  instance,
    const XrCameraDeviceCreateInfoPICO*         createInfo,
    XrFutureEXT*                                future);

XRAPI_ATTR XrResult XRAPI_CALL xrCreateCameraDeviceCompletePICO(
    XrInstance                                  instance,
    XrFutureEXT                                 future,
    XrCreateCameraDeviceCompletionPICO*         completion);

XRAPI_ATTR XrResult XRAPI_CALL xrDestroyCameraDevicePICO(
    XrCameraDevicePICO                          device);

XRAPI_ATTR XrResult XRAPI_CALL xrCreateCameraCaptureSessionAsyncPICO(
    XrSession                                   session,
    const XrCameraCaptureSessionCreateInfoPICO* createInfo,
    XrFutureEXT*                                future);

XRAPI_ATTR XrResult XRAPI_CALL xrCreateCameraCaptureSessionCompletePICO(
    XrSession                                   session,
    XrFutureEXT                                 future,
    XrCreateCameraCaptureSessionCompletionPICO* completion);

XRAPI_ATTR XrResult XRAPI_CALL xrDestroyCameraCaptureSessionPICO(
    XrCameraCaptureSessionPICO                  captureSession);

XRAPI_ATTR XrResult XRAPI_CALL xrGetCameraIntrinsicsPICO(
    XrCameraCaptureSessionPICO                  session,
    XrCameraIntrinsicsPICO*                     intrinsics);

XRAPI_ATTR XrResult XRAPI_CALL xrGetCameraExtrinsicsPICO(
    XrCameraCaptureSessionPICO                  session,
    XrCameraExtrinsicsPICO*                     extrinsics);

XRAPI_ATTR XrResult XRAPI_CALL xrBeginCameraCapturePICO(
    XrCameraCaptureSessionPICO                  session,
    XrCameraCaptureBeginInfoPICO*               beginInfo);

XRAPI_ATTR XrResult XRAPI_CALL xrEndCameraCapturePICO(
    XrCameraCaptureSessionPICO                  session);

XRAPI_ATTR XrResult XRAPI_CALL xrAcquireCameraImagePICO(
    XrCameraCaptureSessionPICO                  session,
    const XrCameraImageAcquireInfoPICO*         acquireInfo,
    XrCameraImagePICO*                          image);

XRAPI_ATTR XrResult XRAPI_CALL xrGetCameraImageDataPICO(
    XrCameraCaptureSessionPICO                  session,
    XrCameraImageIdPICO                         imageId,
    XrCameraImageDataBaseHeaderPICO*            imageData);

XRAPI_ATTR XrResult XRAPI_CALL xrReleaseCameraImagePICO(
    XrCameraCaptureSessionPICO                  session,
    XrCameraImageIdPICO                         imageId);
#endif /* XR_EXTENSION_PROTOTYPES */
#endif /* !XR_NO_PROTOTYPES */
...
#define XR_PICO_spatial_sensing_SPEC_VERSION 2
...
typedef struct XrSpatialEntitySphereGetInfoPICO {
    XrStructureType                     type;
    const void* XR_MAY_ALIAS            next;
    XrSpatialEntityIdPICO               entity;
    XrSpatialEntityComponentTypePICO    componentType;
} XrSpatialEntitySphereGetInfoPICO;

// XrSpatialEntityComponentDataSpherePICO extends XrSpatialEntityComponentDataBaseHeaderPICO
typedef struct XrSpatialEntityComponentDataSpherePICO {
    XrStructureType       type;
    void* XR_MAY_ALIAS    next;
    XrSpheref             sphere;
} XrSpatialEntityComponentDataSpherePICO;
...
/**
 *  XrStructureType : 1010027000 ~ 1010027999
 */


#define XR_PICO_spatial_plane  1
#define XR_PICO_spatial_plane_SPEC_VERSION 1
#define XR_PICO_SPATIAL_PLANE_EXTENSION_NAME "XR_PICO_spatial_plane"

static const XrStructureType XR_TYPE_SYSTEM_SPATIAL_PLANE_PROPERTIES_PICO = (XrStructureType)1010027000;
typedef struct XrSystemSpatialPlanePropertiesPICO {
    XrStructureType         type;
    void*                   next;
    XrBool32                supportsSpatialPlane;
} XrSystemSpatialPlanePropertiesPICO;

static const XrStructureType XR_TYPE_SENSE_DATA_PROVIDER_CREATE_INFO_SPATIAL_PLANE_PICO = (XrStructureType) 1010027001;
typedef struct XrSenseDataProviderCreateInfoSpatialPlanePICO{
    XrStructureType                 type;//XR_TYPE_SENSE_DATA_PROVIDER_CREATE_INFO_SPATIAL_PLANE_PICO
    const void*                     next;
} XrSenseDataProviderCreateInfoSpatialPlanePICO;

typedef enum XrPlaneOrientationPICO {
    XR_PLANE_ORIENTATION_HORIZONTAL_UPWARD_PICO = 0,
    XR_PLANE_ORIENTATION_HORIZONTAL_DOWNWARD_PICO = 1,
    XR_PLANE_ORIENTATION_VERTICAL_PICO = 2,
    XR_PLANE_ORIENTATION_ARBITRARY_PICO = 3,
    XR_PLANE_ORIENTATION_MAX_ENUM_PICO = 0x7FFFFFFF
} XrPlaneOrientationPICO;

// PlaneOrientation
static const XrStructureType XR_TYPE_SPATIAL_ENTITY_PLANE_ORIENTATION_GET_INFO_PICO = (XrStructureType)1010027002;
typedef struct XrSpatialEntityPlaneOrientationGetInfoPICO {
    XrStructureType type;
    const void* next;
    XrSpatialEntityIdPICO entity;
    XrSpatialEntityComponentTypePICO componentType;
} XrSpatialEntityPlaneOrientationGetInfoPICO;

static const XrStructureType XR_TYPE_SPATIAL_ENTITY_PLANE_ORIENTATION_DATA_PICO = (XrStructureType)1010027003;
typedef struct XrSpatialEntityPlaneOrientationDataPICO {
    XrStructureType type;
    void* next;
    XrPlaneOrientationPICO orientation;
} XrSpatialEntityPlaneOrientationDataPICO;

// Orientation filter
static const XrStructureType XR_TYPE_SENSE_DATA_FILTER_PLANE_ORIENTATION_PICO = (XrStructureType)1010027004;
typedef struct XrSenseDataFilterPlaneOrientationPICO {
    XrStructureType type;
    const void* next;
    uint32_t orientationCount;
    XrPlaneOrientationPICO* orientations;
} XrSenseDataFilterPlaneOrientationPICO;

static const XrSpatialEntityComponentTypePICO XR_SPATIAL_ENTITY_COMPONENT_TYPE_PLANE_ORIENTATION_PICO = (XrSpatialEntityComponentTypePICO)1010027000;
