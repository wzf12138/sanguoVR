 ...
 * within this plugin.
 */
class IPICOOpenXRHandInteractionModule : public IInputDeviceModule
{
public:
	/**
	...
	*/
	static inline IPICOOpenXRHandInteractionModule& Get()
	{
		return FModuleManager::LoadModuleChecked<IPICOOpenXRHandInteractionModule>("PICOOpenXRHandInteraction");
	}
	...
	*/
	...
	{
		return FModuleManager::Get().IsModuleLoaded("PICOOpenXRHandInteraction");
	}
