...
#define XR_LIST_ENUM_XrResult(_) \
    ...
    _(XR_ERROR_CAMERA_UNAVAILABLE_PICO, -1010033000) \
    _(XR_ERROR_CAMERA_OCCUPIED_PICO, -1010033001) \
    _(XR_ERROR_CAMERA_CAPTURE_SESSION_CAPTURING_PICO, -1010033002) \
    _(XR_ERROR_CAMERA_CAPTURE_SESSION_NOT_CAPTURING_PICO, -1010033003) \
    _(XR_ERROR_CAMERA_ID_INVALID_PICO, -1010033004) \
    _(XR_ERROR_CAMERA_IMAGE_ID_INVALID_PICO, -1010033005) \
    _(XR_ERROR_CAMERA_PROPERTY_TYPE_INVALID_PICO, -1010033006) \
    _(XR_ERROR_CAMERA_CAPABILITY_TYPE_INVALID_PICO, -1010033007) \
    _(XR_CAMERA_IMAGE_NO_UPDATE_PICO, 1010033000) \
...
#define XR_LIST_ENUM_XrStructureType(_) \
    ...
    _(XR_TYPE_EYE_TRACKER_CREATE_INFO_PICO, 1010006001) \
    _(XR_TYPE_EYE_TRACKER_DATA_INFO_PICO, 1010006002) \
    _(XR_TYPE_EYE_TRACKER_DATA_PICO, 1010006003) \
    _(XR_TYPE_EYE_DATA_PICO, 1010006004) \
    _(XR_TYPE_EYE_TRACKER_GAZE_INFO_PICO, 1010006005) \
    _(XR_TYPE_EYE_TRACKER_GAZE_PICO, 1010006006) \
    _(XR_TYPE_EYE_GAZE_PICO, 1010006007) \
    _(XR_TYPE_EYE_TRACKER_GAZE_DEPTH_PICO, 1010006008) \
    ...
    _(XR_TYPE_SYSTEM_DYNAMIC_OBJECT_TRACKING_PROPERTIES_PICO, 1010017000) \
    _(XR_TYPE_SENSE_DATA_PROVIDER_CREATE_INFO_DYNAMIC_OBJECT_PICO, 1010017001) \
    _(XR_TYPE_SPATIAL_ENTITY_DYNAMIC_OBJECT_GET_INFO_PICO, 1010017002) \
    _(XR_TYPE_SPATIAL_ENTITY_COMPONENT_DATA_DYNAMIC_OBJECT_PICO, 1010017003) \
    _(XR_TYPE_DYNAMIC_OBJECT_DATA_PICO, 1010017004) \
    _(XR_TYPE_SENSE_DATA_FILTER_DYNAMIC_OBJECT_TYPE_PICO, 1010017005) \
    _(XR_TYPE_SYSTEM_DYNAMIC_OBJECT_KEYBOARD_PROPERTIES_PICO, 1010018000) \
    _(XR_TYPE_SYSTEM_DYNAMIC_OBJECT_MOUSE_PROPERTIES_PICO, 1010019000) \
    _(XR_TYPE_LAYER_COLOR_MATRIX_PICO, 1010026000) \
    _(XR_TYPE_AVAILABLE_CAMERAS_ENUMERATE_INFO_PICO, 1010033000) \
    _(XR_TYPE_CAMERA_PROPERTIES_GET_INFO_PICO, 1010033001) \
    _(XR_TYPE_CAMERA_PROPERTIES_PICO, 1010033002) \
    _(XR_TYPE_CAMERA_PROPERTY_FACING_PICO, 1010033003) \
    _(XR_TYPE_CAMERA_PROPERTY_POSITION_PICO, 1010033004) \
    _(XR_TYPE_CAMERA_PROPERTY_CAMERA_TYPE_PICO, 1010033005) \
    _(XR_TYPE_CAMERA_SUPPORTED_CAPABILITIES_GET_INFO_PICO, 1010033006) \
    _(XR_TYPE_CAMERA_SUPPORTED_CAPABILITIES_PICO, 1010033007) \
    _(XR_TYPE_CAMERA_SUPPORTED_CAPABILITY_IMAGE_RESOLUTION_PICO, 1010033008) \
    _(XR_TYPE_CAMERA_CAPABILITY_IMAGE_RESOLUTION_PICO, 1010033009) \
    _(XR_TYPE_CAMERA_SUPPORTED_CAPABILITY_DATA_TRANSFER_TYPE_PICO, 1010033010) \
    _(XR_TYPE_CAMERA_CAPABILITY_DATA_TRANSFER_TYPE_PICO, 1010033011) \
    _(XR_TYPE_CAMERA_SUPPORTED_CAPABILITY_IMAGE_FORMAT_PICO, 1010033012) \
    _(XR_TYPE_CAMERA_CAPABILITY_IMAGE_FORMAT_PICO, 1010033013) \
    _(XR_TYPE_CAMERA_SUPPORTED_CAPABILITY_CAMERA_MODEL_PICO, 1010033014) \
    _(XR_TYPE_CAMERA_CAPABILITY_CAMERA_MODEL_PICO, 1010033015) \
    _(XR_TYPE_CAMERA_SUPPORTED_CAPABILITY_IMAGE_FPS_PICO, 1010033016) \
    _(XR_TYPE_CAMERA_CAPABILITY_IMAGE_FPS_PICO, 1010033017) \
    _(XR_TYPE_CAMERA_DEVICE_CREATE_INFO_PICO, 1010033018) \
    _(XR_TYPE_CREATE_CAMERA_DEVICE_COMPLETION_PICO, 1010033019) \
    _(XR_TYPE_CAMERA_CAPTURE_SESSION_CREATE_INFO_PICO, 1010033020) \
    _(XR_TYPE_CREATE_CAMERA_CAPTURE_SESSION_COMPLETION_PICO, 1010033021) \
    _(XR_TYPE_CAMERA_INTRINSICS_PICO, 1010033022) \
    _(XR_TYPE_CAMERA_EXTRINSICS_PICO, 1010033023) \
    _(XR_TYPE_CAMERA_CAPTURE_BEGIN_INFO_PICO, 1010033024) \
    _(XR_TYPE_CAMERA_IMAGE_ACQUIRE_INFO_PICO, 1010033025) \
    _(XR_TYPE_CAMERA_IMAGE_PICO, 1010033026) \
    _(XR_TYPE_CAMERA_IMAGE_DATA_RAW_BUFFER_PICO, 1010033027) \
    _(XR_TYPE_CAMERA_CAPABILITIES_PICO, 1010033028) \
    _(XR_TYPE_READBACK_TENSOR_BUFFER_PICO, 1010029000) \
    _(XR_TYPE_CREATE_BUFFER_FROM_GLOBAL_TENSOR_COMPLETION_PICO, 1010029001) \
    _(XR_TYPE_CREATE_TEXTURE_FROM_GLOBAL_TENSOR_COMPLETION_PICO, 1010029002) \
    _(XR_TYPE_READBACK_TEXTURE_IMAGE_VULKAN_PICO, 1010030000) \
    _(XR_TYPE_READBACK_TEXTURE_IMAGE_OPENGL_PICO, 1010031000) \
    ...
    _(XR_TYPE_SPATIAL_ENTITY_SPHERE_GET_INFO_PICO, 1200389029) \
    _(XR_TYPE_SPATIAL_ENTITY_COMPONENT_DATA_SPHERE_PICO, 1200389030) \
    ...
    _(XR_TYPE_SHARED_SPATIAL_ANCHOR_DOWNLOAD_INFO_PICO, 1200391003) \
    _(XR_TYPE_SHARED_SPATIAL_ANCHOR_DOWNLOAD_COMPLETION_PICO, 1200391004) \
...
#define XR_LIST_ENUM_XrObjectType(_) \
    ...
    _(XR_OBJECT_TYPE_CAMERA_DEVICE_PICO, 1010033000) \
    _(XR_OBJECT_TYPE_CAMERA_CAPTURE_SESSION_PICO, 1010033001) \
    _(XR_OBJECT_TYPE_READBACK_TEXTURE_PICO, 1010029000) \
...
#define XR_LIST_ENUM_XrDynamicObjectTypePICO(_) \
    _(XR_DYNAMIC_OBJECT_TYPE_UNKNOWN_PICO, 0) \
    _(XR_DYNAMIC_OBJECT_TYPE_KEYBOARD_PICO, 1010018000) \
    _(XR_DYNAMIC_OBJECT_TYPE_MOUSE_PICO, 1010019000) \
    _(XR_DYNAMIC_OBJECT_TYPE_MAX_ENUM_PICO, 0x7FFFFFFF)
...
#define XR_LIST_ENUM_XrSpatialEntityComponentTypePICO(_) \
    ...
    _(XR_SPATIAL_ENTITY_COMPONENT_TYPE_SPHERE_PICO, 6) \
    _(XR_SPATIAL_ENTITY_COMPONENT_TYPE_DYNAMIC_OBJECT_PICO, 1010017000) \
    _(XR_SPATIAL_ENTITY_COMPONENT_TYPE_MAX_ENUM_PICO, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrCameraPropertyTypePICO(_) \
    _(XR_CAMERA_PROPERTY_TYPE_FACING_PICO, 1) \
    _(XR_CAMERA_PROPERTY_TYPE_POSITION_PICO, 2) \
    _(XR_CAMERA_PROPERTY_TYPE_CAMERA_TYPE_PICO, 3) \
    _(XR_CAMERA_PROPERTY_TYPE_MAX_ENUM_PICO, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrCameraFacingPICO(_) \
    _(XR_CAMERA_FACING_WORLD_PICO, 1) \
    _(XR_CAMERA_FACING_MAX_ENUM_PICO, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrCameraPositionPICO(_) \
    _(XR_CAMERA_POSITION_UNSPECIFIED_PICO, 1) \
    _(XR_CAMERA_POSITION_LEFT_PICO, 2) \
    _(XR_CAMERA_POSITION_RIGHT_PICO, 3) \
    _(XR_CAMERA_POSITION_MAX_ENUM_PICO, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrCameraTypePICO(_) \
    _(XR_CAMERA_TYPE_PASSTHROUGH_COLOR_PICO, 1) \
    _(XR_CAMERA_TYPE_MAX_ENUM_PICO, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrCameraCapabilityTypePICO(_) \
    _(XR_CAMERA_CAPABILITY_TYPE_IMAGE_RESOLUTION_PICO, 1) \
    _(XR_CAMERA_CAPABILITY_TYPE_IMAGE_FORMAT_PICO, 2) \
    _(XR_CAMERA_CAPABILITY_TYPE_DATA_TRANSFER_TYPE_PICO, 3) \
    _(XR_CAMERA_CAPABILITY_TYPE_CAMERA_MODEL_PICO, 4) \
    _(XR_CAMERA_CAPABILITY_TYPE_IMAGE_FPS_PICO, 5) \
    _(XR_CAMERA_CAPABILITY_TYPE_MAX_ENUM_PICO, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrCameraDataTransferTypePICO(_) \
    _(XR_CAMERA_DATA_TRANSFER_TYPE_RAW_BUFFER_PICO, 1) \
    _(XR_CAMERA_DATA_TRANSFER_TYPE_MAX_ENUM_PICO, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrCameraImageFormatPICO(_) \
    _(XR_CAMERA_IMAGE_FORMAT_RGBA_8888_PICO, 1) \
    _(XR_CAMERA_IMAGE_FORMAT_MAX_ENUM_PICO, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrCameraModelPICO(_) \
    _(XR_CAMERA_MODEL_PINHOLE_PICO, 1) \
    _(XR_CAMERA_MODEL_MAX_ENUM_PICO, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrCameraImageFpsPICO(_) \
    _(XR_CAMERA_IMAGE_FPS_30_PICO, 1) \
    _(XR_CAMERA_IMAGE_FPS_60_PICO, 2) \
    _(XR_CAMERA_IMAGE_FPS_MAX_ENUM_PICO, 0x7FFFFFFF)
...
/// Calls your macro with the name of each member of XrEyeTrackerGazeInfoPICO, in order.
#define XR_LIST_STRUCT_XrEyeTrackerGazeInfoPICO(_) \
    _(type) \
    _(next) \
    _(flags) \
    _(time) \
...
/// Calls your macro with the name of each member of XrEyeGazePICO, in order.
#define XR_LIST_STRUCT_XrEyeGazePICO(_) \
    _(type) \
    _(next) \
    _(isValid) \
    _(pose) \

/// Calls your macro with the name of each member of XrEyeTrackerGazePICO, in order.
#define XR_LIST_STRUCT_XrEyeTrackerGazePICO(_) \
    _(type) \
    _(next) \
    _(leftEyeGaze) \
    _(rightEyeGaze) \

/// Calls your macro with the name of each member of XrEyeTrackerGazeDepthPICO, in order.
#define XR_LIST_STRUCT_XrEyeTrackerGazeDepthPICO(_) \
    _(type) \
    _(next) \
    _(isValid) \
    _(depthConfidence) \
...
/// Calls your macro with the name of each member of XrSystemDynamicObjectTrackingPropertiesPICO, in order.
#define XR_LIST_STRUCT_XrSystemDynamicObjectTrackingPropertiesPICO(_) \
    _(type) \
    _(next) \
    _(supportsDynamicObjectTracking) \

/// Calls your macro with the name of each member of XrSenseDataProviderCreateInfoDynamicObjectPICO, in order.
#define XR_LIST_STRUCT_XrSenseDataProviderCreateInfoDynamicObjectPICO(_) \
    _(type) \
    _(next) \
    _(trackingTypeCount) \
    _(trackingTypes) \

/// Calls your macro with the name of each member of XrSpatialEntityDynamicObjectGetInfoPICO, in order.
#define XR_LIST_STRUCT_XrSpatialEntityDynamicObjectGetInfoPICO(_) \
    _(type) \
    _(next) \
    _(entity) \
    _(componentType) \

/// Calls your macro with the name of each member of XrDynamicObjectDataPICO, in order.
#define XR_LIST_STRUCT_XrDynamicObjectDataPICO(_) \
    _(type) \
    _(next) \
    _(objectType) \

/// Calls your macro with the name of each member of XrSpatialEntityComponentDataDynamicObjectPICO, in order.
#define XR_LIST_STRUCT_XrSpatialEntityComponentDataDynamicObjectPICO(_) \
    _(type) \
    _(next) \
    _(data) \

/// Calls your macro with the name of each member of XrSenseDataFilterDynamicObjectTypePICO, in order.
#define XR_LIST_STRUCT_XrSenseDataFilterDynamicObjectTypePICO(_) \
    _(type) \
    _(next) \
    _(typeCount) \
    _(types) \

/// Calls your macro with the name of each member of XrSystemDynamicObjectKeyboardPropertiesPICO, in order.
#define XR_LIST_STRUCT_XrSystemDynamicObjectKeyboardPropertiesPICO(_) \
    _(type) \
    _(next) \
    _(supportsDynamicObjectKeyboard) \

/// Calls your macro with the name of each member of XrSystemDynamicObjectMousePropertiesPICO, in order.
#define XR_LIST_STRUCT_XrSystemDynamicObjectMousePropertiesPICO(_) \
    _(type) \
    _(next) \
...
/// Calls your macro with the name of each member of XrReadbackTextureImageBaseHeaderPICO, in order.
#define XR_LIST_STRUCT_XrReadbackTextureImageBaseHeaderPICO(_) \
    _(type) \
    _(next) \
...
/// Calls your macro with the name of each member of XrCameraPropertyBaseHeaderPICO, in order.
#define XR_LIST_STRUCT_XrCameraPropertyBaseHeaderPICO(_) \
    _(type) \
    _(next) \

/// Calls your macro with the name of each member of XrCameraPropertiesPICO, in order.
#define XR_LIST_STRUCT_XrCameraPropertiesPICO(_) \
    _(type) \
    _(next) \
    _(propertyCount) \
    _(properties) \

/// Calls your macro with the name of each member of XrCameraCapabilityBaseHeaderPICO, in order.
#define XR_LIST_STRUCT_XrCameraCapabilityBaseHeaderPICO(_) \
    _(type) \
    _(next) \

/// Calls your macro with the name of each member of XrCameraCapabilitiesPICO, in order.
#define XR_LIST_STRUCT_XrCameraCapabilitiesPICO(_) \
    _(type) \
    _(next) \
    _(capabilityCount) \
    _(capabilities) \

/// Calls your macro with the name of each member of XrAvailableCamerasEnumerateInfoPICO, in order.
#define XR_LIST_STRUCT_XrAvailableCamerasEnumerateInfoPICO(_) \
    _(type) \
    _(next) \
    _(properties) \
    _(capabilities) \

/// Calls your macro with the name of each member of XrCameraPropertiesGetInfoPICO, in order.
#define XR_LIST_STRUCT_XrCameraPropertiesGetInfoPICO(_) \
    _(type) \
    _(next) \
    _(cameraId) \

/// Calls your macro with the name of each member of XrCameraPropertyFacingPICO, in order.
#define XR_LIST_STRUCT_XrCameraPropertyFacingPICO(_) \
    _(type) \
    _(next) \
    _(facing) \

/// Calls your macro with the name of each member of XrCameraPropertyPositionPICO, in order.
#define XR_LIST_STRUCT_XrCameraPropertyPositionPICO(_) \
    _(type) \
    _(next) \
    _(position) \

/// Calls your macro with the name of each member of XrCameraPropertyCameraTypePICO, in order.
#define XR_LIST_STRUCT_XrCameraPropertyCameraTypePICO(_) \
    _(type) \
    _(next) \
    _(cameraType) \

/// Calls your macro with the name of each member of XrCameraSupportedCapabilitiesGetInfoPICO, in order.
#define XR_LIST_STRUCT_XrCameraSupportedCapabilitiesGetInfoPICO(_) \
    _(type) \
    _(next) \
    _(id) \

/// Calls your macro with the name of each member of XrCameraSupportedCapabilityBaseHeaderPICO, in order.
#define XR_LIST_STRUCT_XrCameraSupportedCapabilityBaseHeaderPICO(_) \
    _(type) \
    _(next) \

/// Calls your macro with the name of each member of XrCameraSupportedCapabilitiesPICO, in order.
#define XR_LIST_STRUCT_XrCameraSupportedCapabilitiesPICO(_) \
    _(type) \
    _(next) \
    _(capabilityCount) \
    _(capabilities) \

/// Calls your macro with the name of each member of XrCameraSupportedCapabilityImageResolutionPICO, in order.
#define XR_LIST_STRUCT_XrCameraSupportedCapabilityImageResolutionPICO(_) \
    _(type) \
    _(next) \
    _(resolutionCapacityInput) \
    _(resolutionCountOutput) \
    _(resolutions) \

/// Calls your macro with the name of each member of XrCameraCapabilityImageResolutionPICO, in order.
#define XR_LIST_STRUCT_XrCameraCapabilityImageResolutionPICO(_) \
    _(type) \
    _(next) \
    _(resolution) \

/// Calls your macro with the name of each member of XrCameraSupportedCapabilityDataTransferTypePICO, in order.
#define XR_LIST_STRUCT_XrCameraSupportedCapabilityDataTransferTypePICO(_) \
    _(type) \
    _(next) \
    _(typeCapacityInput) \
    _(typeCountOutput) \
...
/// Calls your macro with the name of each member of XrCameraCapabilityDataTransferTypePICO, in order.
#define XR_LIST_STRUCT_XrCameraCapabilityDataTransferTypePICO(_) \
    _(type) \
    _(next) \
    _(transferType) \

/// Calls your macro with the name of each member of XrCameraSupportedCapabilityImageFormatPICO, in order.
#define XR_LIST_STRUCT_XrCameraSupportedCapabilityImageFormatPICO(_) \
    _(type) \
    _(next) \
...
/// Calls your macro with the name of each member of XrCameraCapabilityImageFormatPICO, in order.
#define XR_LIST_STRUCT_XrCameraCapabilityImageFormatPICO(_) \
    _(type) \
    _(next) \
    _(format) \

/// Calls your macro with the name of each member of XrCameraSupportedCapabilityCameraModelPICO, in order.
#define XR_LIST_STRUCT_XrCameraSupportedCapabilityCameraModelPICO(_) \
    _(type) \
    _(next) \
...
/// Calls your macro with the name of each member of XrCameraCapabilityCameraModelPICO, in order.
#define XR_LIST_STRUCT_XrCameraCapabilityCameraModelPICO(_) \
    _(type) \
    _(next) \
    _(model) \

/// Calls your macro with the name of each member of XrCameraSupportedCapabilityImageFpsPICO, in order.
#define XR_LIST_STRUCT_XrCameraSupportedCapabilityImageFpsPICO(_) \
    _(type) \
    _(next) \
    _(fpsCapacityInput) \
    _(fpsCountOutput) \
...
/// Calls your macro with the name of each member of XrCameraCapabilityImageFpsPICO, in order.
#define XR_LIST_STRUCT_XrCameraCapabilityImageFpsPICO(_) \
    _(type) \
    _(next) \
    _(fps) \

/// Calls your macro with the name of each member of XrCameraDeviceCreateInfoPICO, in order.
#define XR_LIST_STRUCT_XrCameraDeviceCreateInfoPICO(_) \
    _(type) \
    _(next) \
    _(cameraId) \

/// Calls your macro with the name of each member of XrCreateCameraDeviceCompletionPICO, in order.
#define XR_LIST_STRUCT_XrCreateCameraDeviceCompletionPICO(_) \
    _(type) \
    _(next) \
    _(futureResult) \
    _(device) \

/// Calls your macro with the name of each member of XrCameraCaptureSessionCreateInfoPICO, in order.
#define XR_LIST_STRUCT_XrCameraCaptureSessionCreateInfoPICO(_) \
    _(type) \
    _(next) \
    _(camera) \
    _(configCount) \
...
/// Calls your macro with the name of each member of XrCreateCameraCaptureSessionCompletionPICO, in order.
#define XR_LIST_STRUCT_XrCreateCameraCaptureSessionCompletionPICO(_) \
    _(type) \
    _(next) \
    _(futureResult) \
    _(captureSession) \

/// Calls your macro with the name of each member of XrCameraIntrinsicsPICO, in order.
#define XR_LIST_STRUCT_XrCameraIntrinsicsPICO(_) \
    _(type) \
    _(next) \
    _(focalLength) \
    _(principalPoint) \
...
/// Calls your macro with the name of each member of XrCameraExtrinsicsPICO, in order.
#define XR_LIST_STRUCT_XrCameraExtrinsicsPICO(_) \
    _(type) \
    _(next) \
    _(pose) \

/// Calls your macro with the name of each member of XrCameraCaptureBeginInfoPICO, in order.
#define XR_LIST_STRUCT_XrCameraCaptureBeginInfoPICO(_) \
    _(type) \
    _(next) \

/// Calls your macro with the name of each member of XrCameraImageAcquireInfoPICO, in order.
#define XR_LIST_STRUCT_XrCameraImageAcquireInfoPICO(_) \
    _(type) \
    _(next) \
    _(lastCaptureTime) \

/// Calls your macro with the name of each member of XrCameraImagePICO, in order.
#define XR_LIST_STRUCT_XrCameraImagePICO(_) \
    _(type) \
    _(next) \
    _(captureTime) \
    _(imageId) \

/// Calls your macro with the name of each member of XrCameraImageDataBaseHeaderPICO, in order.
#define XR_LIST_STRUCT_XrCameraImageDataBaseHeaderPICO(_) \
    _(type) \
    _(next) \

/// Calls your macro with the name of each member of XrCameraImageDataRawBufferPICO, in order.
#define XR_LIST_STRUCT_XrCameraImageDataRawBufferPICO(_) \
    _(type) \
    _(next) \
    _(width) \
    _(height) \
...
/// Calls your macro with the name of each member of XrSpatialEntitySphereGetInfoPICO, in order.
#define XR_LIST_STRUCT_XrSpatialEntitySphereGetInfoPICO(_) \
    _(type) \
    _(next) \
    _(entity) \
    _(componentType) \

/// Calls your macro with the name of each member of XrSpatialEntityComponentDataSpherePICO, in order.
#define XR_LIST_STRUCT_XrSpatialEntityComponentDataSpherePICO(_) \
    _(type) \
    _(next) \
    _(sphere) \
...
#define XR_LIST_STRUCTURE_TYPES_CORE(_) \
    ...
    _(XrEyeTrackerGazeInfoPICO, XR_TYPE_EYE_TRACKER_GAZE_INFO_PICO) \
    ...
    _(XrEyeGazePICO, XR_TYPE_EYE_GAZE_PICO) \
    _(XrEyeTrackerGazePICO, XR_TYPE_EYE_TRACKER_GAZE_PICO) \
    ...
    _(XrSystemDynamicObjectTrackingPropertiesPICO, XR_TYPE_SYSTEM_DYNAMIC_OBJECT_TRACKING_PROPERTIES_PICO) \
    _(XrSenseDataProviderCreateInfoDynamicObjectPICO, XR_TYPE_SENSE_DATA_PROVIDER_CREATE_INFO_DYNAMIC_OBJECT_PICO) \
    _(XrSpatialEntityDynamicObjectGetInfoPICO, XR_TYPE_SPATIAL_ENTITY_DYNAMIC_OBJECT_GET_INFO_PICO) \
    _(XrDynamicObjectDataPICO, XR_TYPE_DYNAMIC_OBJECT_DATA_PICO) \
    _(XrSpatialEntityComponentDataDynamicObjectPICO, XR_TYPE_SPATIAL_ENTITY_COMPONENT_DATA_DYNAMIC_OBJECT_PICO) \
    _(XrSenseDataFilterDynamicObjectTypePICO, XR_TYPE_SENSE_DATA_FILTER_DYNAMIC_OBJECT_TYPE_PICO) \
    _(XrSystemDynamicObjectKeyboardPropertiesPICO, XR_TYPE_SYSTEM_DYNAMIC_OBJECT_KEYBOARD_PROPERTIES_PICO) \
    ...
    _(XrCameraPropertiesPICO, XR_TYPE_CAMERA_PROPERTIES_PICO) \
    _(XrCameraCapabilitiesPICO, XR_TYPE_CAMERA_CAPABILITIES_PICO) \
    _(XrAvailableCamerasEnumerateInfoPICO, XR_TYPE_AVAILABLE_CAMERAS_ENUMERATE_INFO_PICO) \
    _(XrCameraPropertiesGetInfoPICO, XR_TYPE_CAMERA_PROPERTIES_GET_INFO_PICO) \
    _(XrCameraPropertyFacingPICO, XR_TYPE_CAMERA_PROPERTY_FACING_PICO) \
    _(XrCameraPropertyPositionPICO, XR_TYPE_CAMERA_PROPERTY_POSITION_PICO) \
    _(XrCameraPropertyCameraTypePICO, XR_TYPE_CAMERA_PROPERTY_CAMERA_TYPE_PICO) \
    _(XrCameraSupportedCapabilitiesGetInfoPICO, XR_TYPE_CAMERA_SUPPORTED_CAPABILITIES_GET_INFO_PICO) \
    _(XrCameraSupportedCapabilitiesPICO, XR_TYPE_CAMERA_SUPPORTED_CAPABILITIES_PICO) \
    _(XrCameraSupportedCapabilityImageResolutionPICO, XR_TYPE_CAMERA_SUPPORTED_CAPABILITY_IMAGE_RESOLUTION_PICO) \
    _(XrCameraCapabilityImageResolutionPICO, XR_TYPE_CAMERA_CAPABILITY_IMAGE_RESOLUTION_PICO) \
    _(XrCameraSupportedCapabilityDataTransferTypePICO, XR_TYPE_CAMERA_SUPPORTED_CAPABILITY_DATA_TRANSFER_TYPE_PICO) \
    _(XrCameraCapabilityDataTransferTypePICO, XR_TYPE_CAMERA_CAPABILITY_DATA_TRANSFER_TYPE_PICO) \
    _(XrCameraSupportedCapabilityImageFormatPICO, XR_TYPE_CAMERA_SUPPORTED_CAPABILITY_IMAGE_FORMAT_PICO) \
    _(XrCameraCapabilityImageFormatPICO, XR_TYPE_CAMERA_CAPABILITY_IMAGE_FORMAT_PICO) \
    _(XrCameraSupportedCapabilityCameraModelPICO, XR_TYPE_CAMERA_SUPPORTED_CAPABILITY_CAMERA_MODEL_PICO) \
    _(XrCameraCapabilityCameraModelPICO, XR_TYPE_CAMERA_CAPABILITY_CAMERA_MODEL_PICO) \
    _(XrCameraSupportedCapabilityImageFpsPICO, XR_TYPE_CAMERA_SUPPORTED_CAPABILITY_IMAGE_FPS_PICO) \
    _(XrCameraCapabilityImageFpsPICO, XR_TYPE_CAMERA_CAPABILITY_IMAGE_FPS_PICO) \
    _(XrCameraDeviceCreateInfoPICO, XR_TYPE_CAMERA_DEVICE_CREATE_INFO_PICO) \
    _(XrCreateCameraDeviceCompletionPICO, XR_TYPE_CREATE_CAMERA_DEVICE_COMPLETION_PICO) \
    _(XrCameraCaptureSessionCreateInfoPICO, XR_TYPE_CAMERA_CAPTURE_SESSION_CREATE_INFO_PICO) \
    _(XrCreateCameraCaptureSessionCompletionPICO, XR_TYPE_CREATE_CAMERA_CAPTURE_SESSION_COMPLETION_PICO) \
    _(XrCameraIntrinsicsPICO, XR_TYPE_CAMERA_INTRINSICS_PICO) \
    _(XrCameraExtrinsicsPICO, XR_TYPE_CAMERA_EXTRINSICS_PICO) \
    _(XrCameraCaptureBeginInfoPICO, XR_TYPE_CAMERA_CAPTURE_BEGIN_INFO_PICO) \
    _(XrCameraImageAcquireInfoPICO, XR_TYPE_CAMERA_IMAGE_ACQUIRE_INFO_PICO) \
    _(XrCameraImagePICO, XR_TYPE_CAMERA_IMAGE_PICO) \
    _(XrCameraImageDataRawBufferPICO, XR_TYPE_CAMERA_IMAGE_DATA_RAW_BUFFER_PICO) \
    ...
    _(XrSpatialEntitySphereGetInfoPICO, XR_TYPE_SPATIAL_ENTITY_SPHERE_GET_INFO_PICO) \
    _(XrSpatialEntityComponentDataSpherePICO, XR_TYPE_SPATIAL_ENTITY_COMPONENT_DATA_SPHERE_PICO) \
    ...
    _(XrSharedSpatialAnchorDownloadInfoPICO, XR_TYPE_SHARED_SPATIAL_ANCHOR_DOWNLOAD_INFO_PICO) \
    _(XrSharedSpatialAnchorDownloadCompletionPICO, XR_TYPE_SHARED_SPATIAL_ANCHOR_DOWNLOAD_COMPLETION_PICO) \
...
#define XR_LIST_EXTENSIONS(_) \
    ...
    _(XR_PICO_dynamic_object_tracking, 10018) \
    _(XR_PICO_dynamic_object_keyboard, 10019) \
    _(XR_PICO_dynamic_object_mouse, 10020) \
    _(XR_PICO_layer_color_matrix, 10027) \
    _(XR_PICO_readback_tensor, 10030) \
    _(XR_PICO_readback_tensor_vulkan, 10031) \
    _(XR_PICO_readback_tensor_opengles, 10032) \
    _(XR_PICO_camera_image, 10034) \
...
#define XR_LIST_FUNCTIONS_XR_PICO_eye_tracker(_) \
    ...
    _(GetEyeGazePICO, PICO_eye_tracker) \
...
/// For every function defined by XR_PICO_camera_image in this version of the spec,
/// calls your macro with the function name and extension name.
/// Trims the leading `xr` from the function name and the leading `XR_` from the feature name,
/// because it is easy to add back but impossible to remove with the preprocessor.
#define XR_LIST_FUNCTIONS_XR_PICO_camera_image(_) \
    _(EnumerateAvailableCamerasPICO, PICO_camera_image) \
    _(EnumerateCameraPropertyTypesPICO, PICO_camera_image) \
    _(GetCameraPropertiesPICO, PICO_camera_image) \
    _(EnumerateCameraCapabilityTypesPICO, PICO_camera_image) \
    _(GetCameraSupportedCapabilitiesPICO, PICO_camera_image) \
    _(CreateCameraDeviceAsyncPICO, PICO_camera_image) \
    _(CreateCameraDeviceCompletePICO, PICO_camera_image) \
    _(DestroyCameraDevicePICO, PICO_camera_image) \
    _(CreateCameraCaptureSessionAsyncPICO, PICO_camera_image) \
    _(CreateCameraCaptureSessionCompletePICO, PICO_camera_image) \
    _(DestroyCameraCaptureSessionPICO, PICO_camera_image) \
    _(GetCameraIntrinsicsPICO, PICO_camera_image) \
    _(GetCameraExtrinsicsPICO, PICO_camera_image) \
    _(BeginCameraCapturePICO, PICO_camera_image) \
    _(EndCameraCapturePICO, PICO_camera_image) \
    _(AcquireCameraImagePICO, PICO_camera_image) \
    _(GetCameraImageDataPICO, PICO_camera_image) \
    _(ReleaseCameraImagePICO, PICO_camera_image) \
