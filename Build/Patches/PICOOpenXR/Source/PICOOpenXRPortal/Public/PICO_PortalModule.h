 ...
 */
	...
	{
		// SettingsModule.RegisterSettings("PICO", "General", "PICOPerformancePackSettings",
		// 	LOCTEXT("PICO PerformancePack SettingsName", "PICO PerformancePack Settings"),
		// 	LOCTEXT("PICO PerformancePack SettingsDescription", "Change how the PICO PerformancePack Settings."),
		// 	GetMutableDefault<UPICO_PerformancePackSettings>()
		// );
		 SettingsModule.RegisterSettings("PICO", "General", "PICOOpenXRSettings",
		 	LOCTEXT("PICOOpenXRSettingsName", "PICO OpenXR Settings"),
		 	LOCTEXT("PICOOpenXRSettingsDescription", "Change how the PICO OpenXR Settings."),
		 ...
		 SettingsModule.RegisterSettings("PICO", "General", "PICORenderingSettings",
		 	...
		 	GetMutableDefault<UPICO_RenderSettings>()
		 );
	}
