...
| M01-T005 | 灰盒竞技场关卡 | awaiting_review（2026-08-13：执行完成，26 Actor 关卡已构建，几何/NavMesh/材质断言全部 PASS；PIE fps 与编辑器目视待审核） | 1v1 测试场景 `Content/VRSanguo/Dev/L_Prototype_1v1.umap`、NavMesh、灰盒布局、尺寸标注 |
