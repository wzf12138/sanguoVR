...
- **本窗口提交与 CI 台账（十三段，红灯未掩盖、历史未重写、判据未放宽）**：
  ...
  **⚠ 断言范围（硬约束）**：本表只声称「**截至 `1b0e34f` 已核验**的提交」，**不声称「本窗口终态」** —— 理由见下条「记录自指」。（原断言为「截至 `8eca4d5`」，随第 5–13 行补记**收紧并前移**至 `1b0e34f`；**每次补记都只是把边界前移一格，不构成终态**。）
